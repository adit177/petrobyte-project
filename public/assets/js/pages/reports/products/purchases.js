...
const pageOpen = (data) => {
  ...
  const _process = (data) => {
    console.log("pge opewrn dadta", data);
    let _return = true;
...
const tab_item = function (element, data) {
...
const tabsTarget = function (element, event) {
  ...
  const tab_category = function (data) {
  ...
  const tab_supplier = function (data) {
  ...
  const tab_invoice = function (data) {
...
const reportsTarget = function (element, event, hybrid = false) {
  ...
  const report_category = function (element, event) {
    const _process = (data) => {
      ...
      _return &&= _process_report_purchase_category(data.data);
    ...
    const _process_report_purchase_category = (data) => {
    ...
    // get target account id [supplier id]
  ...
  const report_item = function (element, event) {
    const _process = (data) => {
      ...
      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_purchase_item(data.data);
    ...
    const _process_report_purchase_item = (data) => {
  ...
  const report_supplier = function (element, event) {
    const _process = (data) => {
      let _return = true;

      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_purchase_supplier(data.data);
    ...
    const _process_report_purchase_supplier = (data) => {
  ...
  const report_invoice = function (element, event) {
    const _process = (data) => {
      let _return = true;

      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_purchase_invoice(data.data);
    ...
    const _process_report_purchase_invoice = (data) => {
  ...
  const common_exe = function () {
    ...
    //    console.log("log of common_exe", element.querySelector('table'))
  ...
  switch (event.value) {
    ...
    case pb.rpt.products.purchases.p.supplier:
      return report_supplier(element, event);

    case pb.rpt.products.purchases.p.invoice:
      return report_invoice(element, event);
...
export const RPP_pageOpen = (data, type) => {
