...
// Private functions
console.log("operations.js me aa gye ");
/**
...
const cardsTarget = function (element, event) {
  console.log("cardsTarget in operation.js me aa gye ")
  /*
   ------------------
   internal functions
   ------------------
