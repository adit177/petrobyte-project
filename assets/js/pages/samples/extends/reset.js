...
const stacksTarget = (element, event) => {
  ...
  switch (event.value) {
    case pb.sam.extends.reset.p.page:
      return _page();
    case pb.sam.extends.reset.p.basic:
      return _basic();
    case pb.sam.extends.reset.p.standard:
      return _standard();
    case pb.sam.extends.reset.p.plugin:
      return _plugin();
    case pb.sam.extends.reset.p.simple:
      return _simple();
    case pb.sam.extends.reset.p.nested:
      return _nested();
    case pb.sam.extends.reset.p.advance:
      return _advance();
    case pb.sam.extends.reset.p.table:
      return _table();
  }
}
...
export const SER_Requests = (data, type) => {
  toastr.success('SER_Requests', 'Request Type: ' + type);
  switch (type) {
