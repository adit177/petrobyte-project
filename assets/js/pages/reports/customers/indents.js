...
const tabsTarget = function (element, event) {
  ...
  const tab_bucket = function (data) {
  ...
  const tab_period = function (data) {
  ...
  const tab_book = function (data) {
    ...
    Object.assign(combineData, redData, StateData);
    $R_form_obj.$global(combineData, element, rdR.form.method.simple);
...
const reportsTarget = function (element, event, hybrid = false) {
  ...
  const report_bucket = function (element, event) {
    const _process = (data) => {
      let _return = true;

      _return &&= _process_key_value_match(data.data);
      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_indent_bucket(data.data);
    ...
    const _process_report_indent_bucket = (data) => {
  ...
  const report_period = function (element, event) {
    const _process = (data) => {
      ...
      _return &&= _process_key_value_match(data.data);
      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_indent_period(data.data);
    ...
    const _process_report_indent_period = (data) => {
  ...
  const report_book = function (element, event) {
    const _process = (data) => {
      let _return = true;

      _return &&= _process_key_value_match(data.data);
      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_indent_book(data.data);
    ...
    const _process_report_indent_book = (data) => {
  ...
  const report_customer = function (element, event) {
    const _process = (data) => {
      ...
      _return &&= _process_key_value_match(data.data);
      _return &&= _process_header_posting(data.data);
      _return &&= _process_report_indent_customer(data.data);
    ...
    const _process_report_indent_customer = (data) => {
  ...
  switch (event.value) {
    case pb.rpt.customers.indents.p.bucket:
      return report_bucket(element, event);

    case pb.rpt.customers.indents.p.period:
      return report_period(element, event);

    case pb.rpt.customers.indents.p.book:
      return report_book(element, event);
...
export const RCI_pageOpen = (data, type) => {
