...
const tableFormation = function (element, data) {
  ...
  redData = $R_table_obj.$_simple(data, pb.fin.balance.summary.t.transact);
...
export const FBSY_loads = function (_event) {
  return eleCheck() ? loadsTarget(get_callEl(), _event) : false;
};

export const FBSY_actions = function (_event) {
  return eleCheck() ? actionsTarget(get_callEl(), _event) : false;
};

// fetching all upcoming required details
export const FBSY_pageOpen = function (data) {
  return pageOpen(data);
};

export const FBSY_modals = function (_event) {
