...
const navtabsTarget = function (element, _event) {
  ...
  const navtab_financials = function (element, event) {
    const _process = (data) => {
      return true;
    }
  ...
  switch (_event.value) {
    case pb.set.configs.reports.p.basic:
      return navtab_basic(element, _event);
    case pb.set.configs.reports.p.customers:
      return navtab_customers(element, _event);
    case pb.set.configs.reports.p.shifts:
      return navtab_shifts(element, _event);
    case pb.set.configs.reports.p.stock:
      return navtab_stock(element, _event);
    case pb.set.configs.reports.p.employees:
      return navtab_employees(element, _event);
    case pb.set.configs.reports.p.financials:
      return navtab_financials(element, _event);
    default:
