...
$.fn.repeater = function (fig) {
  ...
  $(this).each(function () {
    ...
    setList = function (rows) {
      ...
      // remove the first delete button.
      var $filterNested_copy = function ($items, repeaters) {
        return $items.filter(function () {
          return repeaters ?
            $(this).closest(
              pluck(repeaters, 'selector').join(',')
      ...
      var $firstDeleteButton = $filterNested_copy(
        $filterNested_copy($(this).find('[data-repeater-item]'), fig.repeaters)
          .first().find('[data-repeater-delete]'),
        fig.repeaters
      );
